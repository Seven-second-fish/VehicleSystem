...
Window {
    ...
    //             // onClicked: stackView.replace(Qt.createComponent("MusicPlayer.MusicView"))
    //             onClicked: stackView.push(musicView)
    //         }
    ...
    //             onClicked: stackView.replace(Qt.createComponent("Settings.SettingsView"))
    //         }
    ...
    //             onClicked: stackView.replace(Qt.createComponent("VehicleInfo.VehicleInfoView"))
    //         }
    ...
    //             onClicked: stackView.replace(Qt.createComponent("Navigation.NavigationView"))
    //         }
    //     }
